...
This folder will contain the reader-facing Hexagon book.

Its structure and audience will be decided before chapters are drafted. The normative language specification remains in `spec/`.
...
that the eventual chapters must cover.
