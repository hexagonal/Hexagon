...
| captured colour | Chapter 19, “A helper conducts what it captures” | Lexical colour scope; a helper conducts without a parameter; never generalized; numbered in hover where a nearer signature would claim it; see **inlet** and **call mark** |
