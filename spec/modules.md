...
-- module Deep.Nested: extern from "./world.js" …
-- emits Deep/Nested.js with: import { boom } from "./world.js";   -- verbatim: it names
--   Deep/world.js beside the emitted file, which Hexagon does not write (FFI Part 4 §2.1)
...
| Foreign specifiers, relative ones included, are emitted verbatim and resolve from the emitted file's place, never the source file's | §11.1; FFI Part 4 §2.1 |
