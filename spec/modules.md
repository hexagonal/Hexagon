...
| `Alias.name` where the module honors one constraint at several of its own types | §5.5-family refusal naming each honored type and the unambiguous routes: the dot call on a value, or the declaring module's qualified spelling (§5.3) |
