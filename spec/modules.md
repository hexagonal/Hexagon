...
-- a.hex and b.hex, each:
module 用户                                    -- ERROR (parse): a module name is uppercase-start;
                                             --   write module <Name>
                                             -- ERROR at the second header: module 用户 is declared
                                             --   twice: a.hex (line 1) and b.hex (line 1); rename
                                             --   the module (the recovered names collide; no dotted
                                             --   hint, none being lawful)
