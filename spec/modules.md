...
| `export pattern` without a head | "an exported pattern writes its head: `pattern rat(top: BigInt, bottom: BigInt): Rat`" (§4.1.1; Pattern Declarations §2.3) |
