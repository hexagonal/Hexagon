...
| Variance sigil on a transparent declaration (`record Pair(+a, b)` not headed `opaque`) | parse error: "variance is inferred for transparent types; remove the `+`" (§2.1, #205) |
