...
3. **Cross-cutting closure documents** (`decisions-batch-2026-07.md`, `decisions-sol-review-2026-07.md`, `decisions-ml-dialect-bool-2026-07.md` *(added 2026-07-29, #147)*, `decisions-ml-dialect-unit-2026-07.md` *(added 2026-07-30, #159)*, `decisions-ml-dialect-comments-2026-07.md` *(added 2026-07-30, #171)*) are **authoritative until consolidated into their host specs**; where a host has not yet applied a recorded decision, the closure document governs.
