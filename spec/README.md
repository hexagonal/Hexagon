...
3. **Cross-cutting closure documents** (`decisions-batch-2026-07.md`, `decisions-sol-review-2026-07.md`, `decisions-ml-dialect-bool-2026-07.md` *(added 2026-07-29, #147)*, `decisions-ml-dialect-unit-2026-07.md` *(added 2026-07-30, #159)*, `decisions-ml-dialect-comments-2026-07.md` *(added 2026-07-30, #171)*, `decisions-ml-dialect-generalization-2026-08.md` *(added 2026-08-01, #205)*, `decisions-ml-dialect-annotations-2026-08.md` *(added 2026-08-06, #317)*, `decisions-ml-dialect-fun-blocks-2026-08.md` *(added 2026-08-31, #700)*) are **authoritative until consolidated into their host specs**; where a host has not yet applied a recorded decision, the closure document governs.
...
| Declarations | `modules.md` | module identity (the `module` header, several modules per file), the path-free `import`, export/visibility, acyclicity, ESM emission |
| Declarations | `packages.md` | packages: the `hexagon.json` manifest, package names as namespaces, the visible module set and its resolution, npm distribution with source shipped, whole-program compilation across packages, stage-two compiled distribution recorded (#829) |
| Declarations | `intrinsics.md` | the intrinsic door: `extern from "hex:intrinsic"`, keys, gate, how compiler machinery names compiler-known types, door deprecation schedule |
...
| **Resolver / checker** | `declarations-preamble.md`, `functions.md`, `statements-blocks-mutability.md`, `modules.md`, `intrinsics.md` (gate §5; naming compiler-known types §7), `products.md`, `unions.md`, `constraints.md`, `integral-constraint.md`, `method-syntax.md`, `pattern-matching.md`, `pattern-declarations.md` (resolution, the door, coverage), `numeric-literals.md` (defaulting), `effects.md` (colours, marks, enforcement), closure docs (rules not yet hosted) |
