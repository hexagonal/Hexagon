...
| Evidence-seat rule: a constrained variable quantifies only at a function-typed binding; at non-function value bindings — records, tuples, constructor applications, the category — it declines and pins after defaulting, restoring `main`'s meaning and emission for all three shapes, which Step 1 had regressed together (corrected 2026-08-02: no wall predated Step 1 — `main` compiled the tuple clean too); annotated arm errors at the declaration; the two emission-time messages retired behind the representability invariant (every residual-constrained scheme is function-typed) (2026-08-01, round 3 D5) | §13.6; Functions §8.2, §10; Constraints §6.1, §10 |
