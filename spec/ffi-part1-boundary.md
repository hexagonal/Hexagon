...
| Generated `Hex` import alias uses first-free `Hex`, `Hex1`, `Hex2`, … probing over every top-level identifier the module's items can put in that `.d.ts`; user exports are never renamed | §10; Part 12 §11.1 |
