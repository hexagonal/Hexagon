...
union's shared tagged constant named by Unions §6.2.

This exception is explicit and boundary-local:

> An ordinary all-nullary `union` is represented by its tagged constants. An
...
function, or place a small JavaScript enum object/facade beside the dependency. The
