...
**Status:** Decided (ruling on issue #125, 2026-07-28, Fable in the spec seat). Discharges the "narrow private intrinsic door" obligation written in `stdlib-roadmap.md` §5.2 items 2 and 6, whose words existed with nothing built behind them.
