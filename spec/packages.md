...
--   module Deep.Nested with extern from "./world.js": Deep/Nested.js keeps import … from "./world.js" verbatim —
--   it names Deep/world.js, which Hexagon does not write (FFI Part 4 §2.1)
