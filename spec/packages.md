...
| The project is the root package, unnamed unless published, and never qualifies itself; a host may compile a directory holding no manifest as the project, every rule reading it as a project whose manifest is empty | §2.5 |
