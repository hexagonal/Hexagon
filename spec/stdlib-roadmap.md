...
| `NullableCase.*`, `JsKind.*`, `JsConversionReason.*`, and `JsPathSegment.*` constructors are **qualified-only** (no bare prelude auto-import; #511 extended the rule to the latter two) | `ffi.md` §12 |
