...
6. **Borrowed views expose no mutation and require foreign stability**; under valid use, live and snapshot observation coincide, licensing native iteration and two-step lowerings. — Part 1 §2.2; Part 2 §6; Part 10 §2. *(Replacement in progress: snapshot semantics at acquisition, #876 for `Array`, #875 for `JsMap`/`JsSet`; this invariant stands until each lands.)*
