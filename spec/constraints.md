...
| Ordinary binding takes an honored member's spelling | the ordinary rebinding error, in `#reportRebinding`'s house form (§4.6, in force since #339); an **exported** binding draws the refusal with the generalisation law named — legal exactly where it properly generalises the member (§4.6's exemption, #541) |
