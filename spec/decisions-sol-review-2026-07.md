...
**Superseded forms in this record:** the import heads quoted below predate #762 and #829 (`import module X from "./x"` is now `import X`), and the diagnostic quoted under §B names a file where Modules §7.6 now names a module; the hosts govern.
