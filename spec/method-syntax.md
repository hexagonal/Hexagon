...
let n: BigInt = (if c then i + j else p).gcd(s)
                                   ...
                                   --   cannot enter it — one report, at the branch, carrying the
                                   --   boundary fixit; nothing stood down   [was refused twice]
