...
| Primitive companions become source per companion (#344): a migrated companion (`BigInt.hex` first) is the ordinary nominal case; wired instances serve the rest until their milestones, in the fixed migration order | §3.4, §5; Modules §5.3; Constraints §5.3 |
