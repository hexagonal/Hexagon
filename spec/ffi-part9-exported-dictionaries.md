...
| exported constraint member whose parameter or result names a captured foreign collection beneath one of Part 1 §5.4 item 1's containers, inside an opaque representation, or is an open structural record | Part 1 §5.4 items 1, 2, 7 at the member annotation | §3.4 |
