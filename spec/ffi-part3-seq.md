...
| *(#488)* The brand carries the declaring module: the refusal brands `$hex: "Seq"`, and exception identity is the (module, name) pair — supersedes the `$hex: true` spelling in the row above; that row stays as the historical record | §7.4 |
