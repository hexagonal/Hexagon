...
| Integer literal at a scrutinee type honoring no `Num` (`0 =>` at `String`, at a record) | Modules §7.6's missing-instance report for `Num` at the type, as `x == 0` draws there (§2.5) |
