...
| Sole-constructor pattern flips refutable after a union gains a constructor | §5.3's uniform gate line, no flip-specific message — the witness is the arriving constructor, spelled per §7.3's tiers with the route clause where the flipped module cannot spell it (§5.2, #639) |
