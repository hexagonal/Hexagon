...
| payload names a captured foreign collection (`Array(a)`, `JsMap(k, v)`, `JsSet(a)`) | hard error at the declaration; rewrite: carry a `Vector`, or a persistent `Map`/`Set` converted at the construction site (§2; FFI Part 1 §5.4 item 3) |
