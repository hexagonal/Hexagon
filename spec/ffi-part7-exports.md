...
- **The emitted JavaScript is untouched entirely.** The defect and its repair live in the declaration file alone; runtime bindings, exception identity (`name`/`$hex`, #488), and every consumer's imports are exactly what they were.
